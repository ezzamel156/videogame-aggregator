    ...
    <div class="container mx-auto px-4">
        <div class="game-details border-b border-gray-800 pb-12 flex flex-col lg:flex-row">
            ...
            <div class="lg:ml-12 lg:mr-64">
                ...
                <div class="flex flex-wrap items-center mt-8">
                    ...
                    <div class="flex items-center space-x-4 ml-4 lg:mt-0 lg:ml-12">
                        @isset($game['social']['website'])
                            <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                                <a href="{{ $game['social']['website'] }}" class="hover:text-gray-400">
                        ...
                        @isset($game['social']['facebook'])
                            <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                                <a href="{{ $game['social']['facebook'] }}" class="hover:text-gray-400">
                        ...
                        @isset($game['social']['instagram'])
                            <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                                <a href="{{ $game['social']['instagram'] }}" class="hover:text-gray-400">
                        ...
                        @isset($game['social']['twitter'])
                            <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                                <a href="{{ $game['social']['twitter'] }}" class="hover:text-gray-400">
        ...
        <div class="similar-games-container mt-8">
            ...
            <div class="similar-games text-sm grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 xl:grid-cols-6 gap-12">
                @foreach ($game['similarGames'] as $similarGames)
                    <x-game-card :game="$similarGames" />                
                @endforeach
            </div> 
        </div> 
    </div>
